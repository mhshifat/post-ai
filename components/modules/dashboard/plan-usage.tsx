  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col gap-1 mt-5">
        <h3 className="text-sm font-medium text-foreground/50">Credits</h3>
      ...
      <div className="flex flex-col gap-1 mt-5">
        <h3 className="text-sm font-medium text-foreground/50">Domains</h3>
        <p className="flex items-center gap-5 justify-between m-0 text-base font-semibold text-foreground">
          <span>500</span>
          <span>500</span>
        </p>
      ...
      <div className="flex flex-col gap-1 mt-5">
        <h3 className="text-sm font-medium text-foreground/50">Contacts</h3>
        <p className="flex items-center gap-5 justify-between m-0 text-base font-semibold text-foreground">
          <span>500</span>
          <span>500</span>
        </p>
